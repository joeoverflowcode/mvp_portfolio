      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
            ...
            Let me show you how I can help you with your next technology project
          </p>
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[688/490] ">
                <img
                  src={joehero}
                  className="rounded-t-[0.9rem] w-full scale-[1.7] translate-x-[5%] translate-y-[30%] md:scale-[1] md:-translate-y-[0%] md:translate-x-0 lg:scale-[1.1] lg:translate-y-[2%]"
                  width={1024}
                  height={490}
                  alt="AI"
                />
